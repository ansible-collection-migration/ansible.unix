...
from ansible_collections.ansible.unix.plugins.modules import nmcli
...
def mocker_set(mocker, connection_exists=False):
    ...
    """
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.nmcli.HAVE_DBUS', True)
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.nmcli.HAVE_NM_CLIENT', True)
