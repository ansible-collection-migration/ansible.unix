...
from ansible_collections.ansible.unix.tests.unit.compat.mock import call, patch
from ansible_collections.ansible.unix.plugins.modules import rhsm_release
from ansible_collections.ansible.unix.tests.unit.modules.utils import (
...
class RhsmRepositoryReleaseModuleTestCase(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch('ansible_collections.ansible.unix.plugins.modules.rhsm_release.'
        ...
        self.mock_get_bin_path = patch('ansible_collections.ansible.unix.plugins.modules.rhsm_release.'
