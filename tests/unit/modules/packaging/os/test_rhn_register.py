...
from ansible_collections.ansible.unix.tests.unit.compat.mock import mock_open
from ansible.module_utils import basic
from ansible.module_utils._text import to_native
import ansible.module_utils.six
from ansible.module_utils.six.moves import xmlrpc_client
from ansible_collections.ansible.unix.plugins.modules import rhn_register
...
def test_systemid_with_requirements(capfd, mocker, patch_rhn):
    ...
    mocker.patch('ansible_collections.ansible.unix.plugins.modules.rhn_register.open', mock_open(read_data=SYSTEMID), create=True)
