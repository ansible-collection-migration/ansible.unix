from ansible_collections.ansible.unix.tests.unit.compat import mock
from ansible_collections.ansible.unix.tests.unit.compat import unittest

from ansible_collections.ansible.unix.plugins.modules import apk
...
class TestApkQueryLatest(unittest.TestCase):
    ...
    @mock.patch('ansible_collections.ansible.unix.plugins.modules.apk.AnsibleModule')
