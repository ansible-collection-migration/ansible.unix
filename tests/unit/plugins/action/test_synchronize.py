...
from ansible_collections.ansible.unix.tests.unit.compat.mock import patch, MagicMock
from ansible_collections.ansible.unix.plugins.action.synchronize import ActionModule
...
class TestSynchronizeAction(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.unix.plugins.action.synchronize.connection_loader', FakePluginLoader)
    def test_basic(self):
        x = SynchronizeTester()
